...
<body>
  ...
  <header class="header">
    ...
    <div class="title">Full-Stack MERN Developer • CEO of Lugaish • English Instructor & Youth Leader</div>
  ...
  <section class="section">
    ...
    <p class="summary-text">
      Versatile Full-Stack MERN Developer and educational entrepreneur with proven expertise in building responsive, production-ready web applications using MongoDB, Express.js, React, and Node.js. Founder & CEO of Lugaish, a dedicated online language-learning platform for students, where I also teach English. Former District Secretary for Interact District 3281 Bangladesh, successfully coordinating youth initiatives and leadership activities across 2,000+ students. Fellow of the American Center's 2-Year English Access & Leadership Program and international youth delegate in Nepal. Combines robust engineering craftsmanship with strategic negotiation, cross-cultural communication, and proven team leadership.
    </p>
  </section>
